...
function Apple1(){
  ...
  Xapple1 = Math.floor(Math.random() * 58 + 1);
  Yapple1 = Math.floor(Math.random() * 26 + 1);

  while(Xapple1 != 10 && Xapple1 != 50)
    Xapple1 = Math.floor(Math.random() * 58 + 1);

  while(Yapple1 != 10 && Yapple1 != 16)
    Yapple1 = Math.floor(Math.random() * 26 + 1);

  //posição inicial da maçã
  this.body = [Xapple1, Yapple1];
  //cor da maçã
  this.color = "red";
    ...
    this.update = function(){
      ...
      if(this.body[0][0] == apple1.body[0] && this.body[0][1] == apple1.body[1]){
        ...
        for(var i=0 ; i < this.body.length ; i++){
          while(Xapple1==this.body[i][0] && Yapple1==this.body[i][1])
              Xapple1 = Math.floor(Math.random() * 58 + 1);
              Yapple1 = Math.floor(Math.random() * 26 + 1);
        }

        apple1.body[0] = Xapple1;
        apple1.body[1] = Yapple1;
      }
